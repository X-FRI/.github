...
@module("../assets/sourcehut.svg") external sourcehut_logo: string = "default"

@react.component
let make = () => {
  <section id="hostings" className={`${layout["sectionReverse"]}`}>
    ...
    <div className={`${layout["sectionInfo"]}`}>
      ...
      <div className="flex sm:mt-10 mt-6 py-[6px] px-4 bg-black-gradient rounded-[10px] ">
        <a href="https://framagit.org/xfri">
          <img
            src=framagit_logo
            alt="framagit"
        ...
        <a href="https://codeberg.org/xfri/">
          <img
            src=codeberg_logo
            alt="codeberg"
            className="w-[144.17px] h-[43.08px] object-contain cursor-pointer"
